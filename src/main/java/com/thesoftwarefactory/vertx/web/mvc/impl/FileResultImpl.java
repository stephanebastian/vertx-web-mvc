...
public class FileResultImpl implements FileResult {
	...
	public FileResultImpl(java.io.File file) {
	...
	/* (non-Javadoc)
	 * @see vertx.mvc.impl.FileResult#contentType()
	 */
	@Override
    ...
    /* (non-Javadoc)
	 * @see vertx.mvc.impl.FileResult#contentType(java.lang.String)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see vertx.mvc.impl.FileResult#file()
	 */
    @Override
