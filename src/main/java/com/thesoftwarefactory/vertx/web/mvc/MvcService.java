...
public interface MvcService {
	...
	public static MvcService create(TemplateEngine engine) {
		return new MvcServiceImpl(engine);
	}

	public static MvcService get(RoutingContext context) {
		return context.get(MvcService.class.getName());
	}
